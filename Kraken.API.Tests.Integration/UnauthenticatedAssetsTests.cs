...
public sealed class UnauthenticatedAssetsTests : IAsyncLifetime
{
    ...
    {
        _krakenRestServer.SetupUnauthenticatedAssetsDefaultListingRestEndpoint();
    ...
    {
        const uint items = 5;
        _krakenRestServer.SetupUnauthenticatedAssetsSpecificAmountListingRestEndpoint(items);
