using System.Net;
using Kraken.API.Tests.Integration.Resources;
...
public sealed class KrakenRestServerApi : IDisposable
{
    ...
    public KrakenRestServerApi() => _wireMockServer = WireMockServer.Start();
