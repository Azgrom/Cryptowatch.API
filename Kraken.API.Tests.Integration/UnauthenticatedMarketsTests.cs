...
public sealed class UnauthenticatedMarketsTests : IAsyncLifetime
{
    ...
    {
        _krakenRestServer.SetupUnauthenticatedDefaultListingMarketsRestEndpoint();
    ...
    public async Task Asserts_MarketsListingFromCursor_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedMarketsListingFromCursorRestEndpoint();
    ...
    {
        const int items = 3;
        _krakenRestServer.SetupUnauthenticatedThreeMarketsListingRestEndpoint();
    ...
    public async Task Asserts_SpecificMarketAmountFromCursorListing_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedThreeMarketsWithCursorListingRestEndpoint();
    ...
    public async Task Asserts_PairMarketDetail_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedPairMarketDetailRestEndpoint();
    ...
    {
        _krakenRestServer.SetupUnauthenticatedMarketsPricesRestEndpoint();
    ...
    public async Task Asserts_MarketsPricesWithCursor_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedMarketsPricesWithCursorRestEndpoint();
    ...
    public async Task Asserts_MarketsPricesWithCursorAndLimitOfThree_JsonResponseDeserialization()
    {
        const int    items  = 3;
        const string cursor = "BDj0fwwHBUM7Rz4YNJvyhM1vMO5PyygjB-AAht0UbizZZ7_VqEB1JA";
        _krakenRestServer.SetupUnauthenticatedMarketsPricesWithCursorAndLimitOfThreeRestEndpoint();
    ...
    public async Task Asserts_PairMarketPrice_JsonResponseDeserialization()
    {
        const string exchange = "kraken";
        const string pair     = "btcusd";
        _krakenRestServer.SetupUnauthenticatedPairMarketDetailPriceRestEndpoint();
    ...
    public async Task Asserts_MostRecentTrades_JsonResponseDeserialization()
    {
        const string exchange = "kraken";
        const string pair     = "btcusd";
        _krakenRestServer.SetupUnauthenticatedMarketMostRecentTradesOfAPairRestEndpoint();
    ...
    public async Task Asserts_MostRecentTradesWithTimestamp_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedMarketMostRecentTradesOfAPairWithTimestampRestEndpoint();
    ...
    public async Task Asserts_MostRecentTradesWithTimestampAndLimit_JsonResponseDeserialization()
    {
        ...
        const int    cursor   = 1690337054;
        const int    limit    = 5;
        _krakenRestServer.SetupUnauthenticatedMarketMostRecentTradesOfAPairWithTimestampAndLimitRestEndpoint();
    ...
    public async Task Asserts_MarketPairSummary_JsonResponseDeserialization()
    {
        const string exchange = "kraken";
        const string pair     = "btcusd";
        _krakenRestServer.SetupUnauthenticatedMarketPairSummaryRestEndpoint();
    ...
    {
        _krakenRestServer.SetupUnauthenticatedAllMarketsSummariesRestEndpoint();
    ...
    {
        const int limit = 3;
        _krakenRestServer.SetupUnauthenticatedMarketsSummariesWithLimitOf3RestEndpoint();
    ...
    public async Task Asserts_MarketsSummariesFromCursorWithLimitOf3_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedMarketsSummariesFromCursorWithLimitOf3RestEndpoint();
    ...
    public async Task Asserts_AllMarketsSummariesById_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedAllMarketsSummariesByIdRestEndpoint();
    ...
    public async Task Asserts_AllMarketsSummariesByIdFromCursor_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedAllMarketsSummariesByIdFromCursorRestEndpoint();
    ...
    public async Task Asserts_AllMarketsSummariesByIdFromCursorWithLimit_JsonResponseDeserialization()
    {
        ...
        const string cursor = "gCLPH49ToTXjmDnq2VyXCtu5HtSV__AiJU7XjdF1hAwu48pFj0_G70zdGrrKvg";
        const int    limit  = 3;
        _krakenRestServer.SetupUnauthenticatedAllMarketsSummariesByIdFromCursorWithLimitOf3RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOrderBook_JsonResponseDeserialization()
    {
        const string exchange = "kraken";
        const string pair     = "btcusd";
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOrderBookRestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOrderBookWithLimitOf3_JsonResponseDeserialization()
    {
        ...
        const string pair     = "btcusd";
        const uint   limit    = 3;
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOrderBookWithLimitOf3RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOrderBookWithDepthOf60_000_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOrderBookWithDepthOf60_000RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOrderBookWithDepthOf60_000AndLimitOf7_JsonResponseDeserialization()
    {
        ...
        const double depth    = 60_000;
        const uint   limit    = 7;
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOrderBookWithDepthOf60_000AndLimitOf7RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOrderBookWithSpanOfDot875_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOrderBookWithSpanOfDot875RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOrderBookWithSpanOfDot875AndDepthOf13_000_JsonResponseDeserialization()
    {
        ...
        const decimal span     = 0.875M;
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOrderBookWithSpanOfDot875AndDepthOf13_000RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOrderBookLiquidity_JsonResponseDeserialization()
    {
        const string exchange = "kraken";
        const string pair     = "btcusd";
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOrderBookLiquidity_000RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOrderBookCalculator_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOrderBookCalculator_000RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOHLCCandlestick_JsonDeserializationResponse()
    {
        const string exchange = "kraken";
        const string pair     = "btcusd";
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOHLCRestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdFiveMinuteOHLCCandlestick_JsonDeserializationResponse()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcFiveMinuteOHLCRestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOHLCCandlestickAfter01_01_2023Long_JsonDeserializationResponse()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOHLCAfter01_01_2023RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdOneMinuteOHLCCandlestickAfter01_01_2023Long_JsonDeserializationResponse()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOneMinuteOHLCAfter01_01_2023RestEndpoint();
        ...
        Asserts_KrakenBtcUsdOneHourOHLCCandlestickAfter01_01_2023Before02_01_2023Long_JsonDeserializationResponse()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcOneHourOHLCAfter01_01_2023Before02_01_2023RestEndpoint();
    ...
    public async Task Asserts_KrakenBtcUsdFiveMinuteTwoHourOHLCCandlestick_JsonDeserializationResponse()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedKrakenUsdBtcFiveMinuteTwoHourOHLCRestEndpoint();
    ...
    public async Task Asserts_InvalidKrakenBtcUsdOHLCCandlestick_JsonDeserializationResponse()
    {
        ...
        const string    pair      = "btcusd";
        const TimeFrame timeFrame = TimeFrame.min5;
        _krakenRestServer.SetupUnauthenticatedInvalidKrakenUsdBtcOHLCRestEndpoint();
