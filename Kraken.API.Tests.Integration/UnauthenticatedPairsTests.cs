...
public sealed class UnauthenticatedPairsTests : IAsyncLifetime
{
    ...
    {
        _krakenRestServer.SetupUnauthenticatedPairsDefaultListingRestEndpoint();
    ...
    {
        const int items = 5;
        _krakenRestServer.SetupUnauthenticatedPairsSpecificAmountListingRestEndpoint();
        ...
        Asserts_PairsListingWithCursor_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedPairsListingWithCursorRestEndpoint();
        ...
        Asserts_PairsSpecificAmountWithCursorListing_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedPairsSpecificAmountWithCursorListingRestEndpoint();
    ...
    public async Task Asserts_PairsDefaultDetail_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupUnauthenticatedPairsDefaultDetailRestEndpoint();
