...
public sealed class AuthenticatedExchangesTests : IAsyncLifetime
{
    ...
    {
        _krakenRestServer.SetupAuthenticatedExchangesDefaultListingRestEndpoint();
    ...
    public async Task Asserts_ExchangeDetailing_JsonResponseDeserialization()
    {
        ...
        _krakenRestServer.SetupAuthenticatedExchangesDefaultKrakenDetailingRestEndpoint();
